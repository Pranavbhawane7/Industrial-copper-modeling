...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        try:
            with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)

            with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\scaler.pkl", 'rb') as file:
                scaler_loaded = pickle.load(file)

            with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\t.pkl", 'rb') as file:
                t_loaded = pickle.load(file)

            with open(r"C:\\Users\\91888\Desktop\\Copper_modelling\\s.pkl", 'rb') as file:
                s_loaded = pickle.load(file)

        except ValueError as e:
            st.write("An error occurred while loading the model. Please make sure the model files are correct.")
            st.write("Error details:", e)
            st.stop()  # Stop further execution to prevent using the model
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\cscaler.pkl", 'rb') as file:
            cscaler_loaded = pickle.load(file)

        with open(r"C:\\Users\\91888\\Desktop\\Copper_modelling\\ct.pkl", 'rb') as file:
...
st.write(f'<h6 style="color:#ee4647;">App Created by PRANAV BHAWANE</h6>', unsafe_allow_html=True)
